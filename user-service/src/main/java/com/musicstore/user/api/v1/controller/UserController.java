...
public class UserController {
    ...
    @Operation(summary = "Get user by email", description = "Retrieves a user's profile by their email address")
    ...
    @Operation(summary = "Update any user (admin)", description = "Updates any user's profile (admin only)")
    ...
    @Operation(summary = "Update user role (admin)", description = "Updates a user's role (admin only)")
    ...
    @Operation(summary = "Toggle user enabled (admin)", description = "Enables or disables a user account (admin only)")
