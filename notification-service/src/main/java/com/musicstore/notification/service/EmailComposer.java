...
public class EmailComposer {
    ...
    public EmailContent composeOrderConfirmation(Map<String, Object> event) {
        ...
        List<Map<String, Object>> items = (List<
            Map<String, Object>
        >) event.getOrDefault("items", List.of());
        ...
        return new EmailContent("Order Confirmed - #" + orderId, html);
    }
    ...
    public EmailContent composePaymentConfirmation(Map<String, Object> event) {
        ...
        return new EmailContent("Payment Confirmed - Order #" + orderId, html);
    }
    ...
    public EmailContent composeOrderCancellation(Map<String, Object> event) {
        ...
        return new EmailContent("Order Cancelled - #" + orderId, html);
    }

    public EmailContent composeShippingNotification(Map<String, Object> event) {
        Long orderId = toLong(event.get("orderId"));
        String trackingNumber = (String) event.getOrDefault(
            "trackingNumber",
            "N/A"
        );
        String carrier = (String) event.getOrDefault(
            "carrier",
            "Standard Shipping"
        );
        ...
        return new EmailContent("Order Shipped - #" + orderId, html);
    }
